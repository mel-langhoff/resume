...
//   const fontSize = Math.min(canvas.width * 0.14, 140);
//   offCtx.font = `900 ${fontSize}px Arial`;

//   const centerX = offscreen.width / 2;

//   // Position so the TOP of the H sits near the vertical center
//   const firstLineY = offscreen.height / 2 + fontSize * 0.72;

//   // Line spacing
//   const secondLineY = firstLineY + fontSize * 1.05;

//   offCtx.fillText("HI,", centerX, firstLineY);
//   offCtx.fillText("I'M MEL", centerX, secondLineY);
...
document.addEventListener("turbo:load", () => {
  ...
  function buildTextTargets() {
    ...
    offCtx.font = `900 ${Math.min(canvas.width * 0.14, 140)}px Arial`;

    const centerX = offscreen.width * 0.18;
const centerY = window.innerHeight * 0.78;

    offCtx.fillText("HI,", centerX, centerY - 110);
    offCtx.fillText("I'M MEL", centerX, centerY + 50);
